...
function Cart() {
  ...
  return (
    <div className='mt-10'>
      ...
      {cartItems.length >0 ? <div className="grid grid-cols-1 xl:grid-cols-3 text-gray-700 gap-10">
            ...
            <div className='grid grid-cols-4 xl:grid-cols-7 items-center xl:gap-10 gap-2' key={item._id}>
              <div className="col-span-4 flex gap-2 items-center">
                ...
                <div className="flex flex-col gap-2 ">
                  ...
                  <span className='text-xs underline text-red-700 cursor-pointer'
                    onClick={() => {
                      dispatch(RemoveProductFromCart(item._id as string));
                    }}>Remove</span>
                </div>
              </div>

              <span className='col-span-1'> ${item.price}</span>
              <div className='col-span-1 border-solid p-2 border-gray-400 flex gap-2 justify-between'>
        ...
        <div className="col-span-1 border-gray-400 border-solid p-5">
      ...
      </div> : <div className='flex flex-col items-center gap-5 text-gray-700'>
